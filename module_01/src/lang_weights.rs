//! This module contains functions for the language weight lab
//! # Examples:
//! ````
//! use module_01::lang_weights::*;
...
/// This function initialises the languages
/// # Examples:
/// ````
/// use module_01::lang_weights::init_languages;
/// let mut languages = init_languages();
/// ````
...
/// This function calculates the language weights
/// # Examples:
/// ````
/// use module_01::lang_weights::{init_languages,calculate_weights};
/// let mut languages = init_languages();
/// let weights = calculate_weights(&mut languages);
/// ````
